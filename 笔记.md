...
>
> 权限点以树的形式呈现，根据element-ui的el-tree组件完成，把之前拥有的权限显示出来，再进行更改
...
* vue-router提供了一个叫做[addRoute](https://v3.router.vuejs.org/zh/api/#router-addroutes)的API方法，这个方法的含义是**动态添加路由规则**
...
* 在拦截的位置，调用关联action， 获取新增routes，并且**addRoute**
